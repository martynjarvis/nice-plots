...
plt.text(0.2, 0.7, r'$pp\to W+X \to e \nu + X$', size=14)
plt.text(0.2, 0.625, r'$\sqrt{s}=7\ TeV$', size=14)

plt.text(0.2, 0.4, r'$P^{e}_{T} > 25\ GeV$', size=14)
plt.text(0.2, 0.325, r'$\eta^{e}<3.0$', size=14)

#lg = ax.legend( loc='upper right', numpoints = 1 ,prop={'size':14})
#lg.get_frame().set_linewidth(0)

ax.set_xlabel(r'$y_W$')
ax.set_ylabel(r'$\mathcal{A}(y_{W})$')
